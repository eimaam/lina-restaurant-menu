...
export const MenuManagementPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 bg-surface-container-lowest p-3 rounded-2xl border border-outline-variant">
                ...
                {itemForm.sizes.map((size, idx) => (
                  <div key={idx} className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 bg-surface text-xs rounded-xl p-2.5 border border-outline-variant"
                    />
                    <input
                      type="number"
                      placeholder="Price (₦)"
                      ...
                      className="w-28 bg-surface text-xs rounded-xl p-2.5 border border-outline-variant"
                    />
                    <button
                      type="button"
                      onClick={() => {
